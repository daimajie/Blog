    ...
    <div class="layui-fliud">
        <div class="layui-row">
            ...
            <div class="content">
                ...
                <table class="layui-table" lay-data="{url:'<?= Url::to(['get-comments']);?>', page:true, id:'idTest'}" lay-filter="table-data">
                    <thead>
                    <tr>
                        ...
                        <th lay-data="{field:'content'}">评论</th>
        ...
        table.on('tool(table-data)', function(obj){
            ...
            if(obj.event === 'del'){
                layer.confirm('真的删除行么', function(index){
                    layer.close(index);
                    $.ajax({
                        url : UrlManager.createUrl('/admin/comment/comment/del-comment',{id:data.id}),
                        type : 'post',
